...
const filtersForm = reactive({
  ...
  rt: props.filters?.rt ?? '',
  rw: props.filters?.rw ?? '',
  status_kehidupan: props.filters?.status_kehidupan ?? '',
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-7">
            ...
            <div>
              ...
              >
                ...
                <option v-if="userRole === 'admin'" value="Pindah">Pindah</option>
              </select>
            </div>
                ...
                >
                  ...
                  <td class="px-3 py-3">
                    <span
                      ...
                      :class="{
                        'bg-gray-200 text-gray-700': p.status_kehidupan === 'Meninggal',
                        'bg-orange-100 text-orange-700': p.status_kehidupan === 'Pindah',
                        'bg-green-100 text-green-700': !p.status_kehidupan || p.status_kehidupan === 'Hidup',
                      }"
                    >
