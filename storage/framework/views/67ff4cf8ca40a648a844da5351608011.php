...
<div class="page">
    ...
    <tbody>
      <tr>
        <td class="kop-logo-cell">
          <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="kop-logo" />
        </td>
        <td class="kop-text">
  ...
  <div class="data-rows">
    ...
    <div class="data-row">
      ...
      <div class="data-val"><?php echo e($p['alamatAsal'] ?? '' ?: 'RT.___/RW.___ Kelurahan ______ Kec. ______ Kota Kupang'); ?></div>
    </div>
