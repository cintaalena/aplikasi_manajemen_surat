  ...
  <table class="data-table" cellspacing="0" cellpadding="0" style="margin-top:14px;">
    <tbody>
      ...
      <tr>
        ...
        <td class="val"><?php echo e($p['tempatLahir'] ?? ''); ?><?php echo e(isset($p['tanggalLahir']) && $p['tanggalLahir'] ? ', '.bl_tanggalIndo($p['tanggalLahir']) : ''); ?></td>
      </tr>
      <tr><td class="lbl">Jenis Kelamin</td><td class="sep">:</td><td class="val"><?php echo e($p['jenisKelamin'] ?? '' ?: '________'); ?></td></tr>
      ...
      <tr>
        ...
        <td class="val">RT.<?php echo e($p['rt'] ?? '' ?: '___'); ?>/RW.<?php echo e($p['rw'] ?? '' ?: '___'); ?> Kel. Fatubesi Kec. Kota Lama Kota Kupang</td>
      </tr>
    </tbody>
  </table>
